package com.androiddevs.tddshoppinglist.data.local
...
@SmallTest //Opcional (Testes pequenos: testes unitários)
@HiltAndroidTest
class ShoppingDaoTest {
    ...
    fun observeTotalPriceSum() = runBlockingTest {
        ...
        val shoppingItem2 = ShoppingItem("name", 2, 1.3f, "url", 2)
        ...
        assertThat(totalPriceSum).isEqualTo(1 + 2 * 1.3)
    }
}